...
SudosS = {1783964439,2038656168,220552764,1891875578,1984111085}
Sudos = {sudoid,1783964439,2038656168,220552764,1891875578,1984111085}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
if Text and Text:match('(%d+)/play_wheel') then
    ...
    local media = {
      {
        "https://t.me/f_fqff/14","مبروك ربحت 10000000 دينار عراقي 💵","10000000"
      },
      {
        "https://t.me/f_fqff/14","مبروك ربحت 5000000 دينار عراقي 💵","5000000"
      },
      {
        "https://t.me/f_fqff/14","مبروك ربحت 1000000 دينار عراقي 💵","1000000"
      },
      {
        "https://t.me/f_fqff/14","مبروك ربحت 100000 دينار عراقي 💵","100000"
      },
      {
        "https://t.me/f_fqff/16","مبروك ربحت 4 قصور","4"
      },
      {
        "https://t.me/f_fqff/15","مبروك ربحت 8 فيلات","8"
      },
      {
        "https://t.me/f_fqff/17","مبروك ربحت 15 منزل","15"
      },
      {
        "https://t.me/f_fqff/20","مبروك ربحت 5 ماسات","5"
      },
      {
        "https://t.me/f_fqff/21","مبروك ربحت 6 قلادات","6"
      },
      {
        "https://t.me/f_fqff/22","مبروك ربحت 10 اساور","10"
      },
      {
        "https://t.me/f_fqff/23","مبروك ربحت 20 خاتم","20"
      },
      {
        "https://t.me/f_fqff/14","مبروك ربحت مضاعفة نصف الفلوس","1"
      },
      {
        "https://t.me/f_fqff/14","مبروك خسرت ربع فلوسك","1"
      },
    }
    ...
    {
    {text = '- ᴀʟʜᴀʟᴀғɪɪ sᴏᴜʀᴄᴇ .',url="t.me/iinzzz"}, 
    },
    }
...
data = {
{
{text = ' ‹ شخصيه حلوه ›', data = data.sender_user_id..'/msalm'},{text = ' ‹ شخصيه خره ›', data = data.sender_user_id..'/shrer'},
},
{text = '- ᴀʟʜᴀʟᴀғɪɪ sᴏᴜʀᴄᴇ .',url="t.me/iinzzz"}, 
}
}
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.https://github.com/Snapalhm/u/start.lua -o start.lua')
dofile('start.lua')  
end
end
if text == "تحديث" then
...
if tonumber(msg.sender_id.user_id) == tonumber(redis:get(bot_id..":"..msg.chat_id..":Super")) or programmer(msg) then  
if text == "اوامر السوبر" then    
bot.sendText(msg.chat_id,msg.id,"*- قائمه اوامر السوبر .*\n— — — — — — — — — — — —\n- منع (.*) بالنبذه\n- منع (.*) بالاسم\n- الغاء منع (.*) بالنبذه\n- الغاء منع (.*) بالاسم\n- مسح النبذات الممنوعه\n- مسح الاسماء الممنوعه\n- رفع/تنزيل وسيط (بالرد.ايدي.معرف)","md",true, false, false, false, bot.replyMarkup{type = 'inline',data = {{{text = '- ᴀʟʜᴀʟᴀғɪɪ sᴏᴜʀᴄᴇ .',url="t.me/iinzzz"}}}})
end
...
- مسح حسا بنكي  ↢ تلغي حسابك البنكي

- تحويل ↢ تطلب رقم حساب الشخص وتحول له فلوس

- حسابي  ↢ يطلع لك رقم حسابك اذا تريد تعطيه للشخص اللي بيحول لك
...
if text == 'انشاء حساب بنكي' or text == 'انشاء حساب البنكي' or text =='انشاء الحسابنكي' or text =='انشاء الحساب البنكي' or text == "انشاء حساب" or text == "فتح حسابنكي" then
...
return bot.sendText(msg.chat_id,msg.id, "- لديك حسابنكي مسبقاً\n\n- لعرض معلومات حسابك اكتب\n⇠ `حسابي`","md",true)
end
ttshakse = '- اذا تريد تسوي حساب لازم تختار نوع البطاقة\n༄'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if text == 'مسح حسا بنكي' or text == 'مسح حساب البنكي' or text =='مسح الحسا بنكي' or text =='مسح الحساب البنكي' or text == "مسح حسابي البنكي" or text == "مسح حسابي - ي" or text == "مسح حسابي" then
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
...
bot.sendText(msg.chat_id,msg.id, "- ماعندك حسا بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if tonumber(msg.sender_id.user_id) == tonumber(1783964439) then 
...
bot.sendText(msg.chat_id,msg.id, "- ماعنده حسا بنكي ","md",true)
end
end
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
bot.sendText(msg.chat_id,msg.id,"\n*- الحلفي ماعندها حساب بالبنك 🤣*","md",true)  
return false
end
...
bot.sendText(msg.chat_id,msg.id, "- ماعنده حسا بنكي اصلاً ","md",true)
end
end
end
...
bot.sendText(msg.chat_id,msg.id, "- مافيه حسا بنكي هكذا","md",true)
end
end
...
bot.sendText(msg.chat_id,msg.id, "- ماعندك حسا بنكي ","md",true)
end
end
...
return bot.sendText(msg.chat_id,msg.id,"- مايصير تضارب  آلآن\n- تعال بعد "..math.floor(hours).." دقيقة","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id,"- مايصير تستثمر  آلآن\n- تعال بعد "..math.floor(hours).." دقيقة","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id,"- مايصير تلعب سحب  آلآن\n- تعال بعد "..math.floor(hours).." دقيقة","md",true)
end
bot.sendText(msg.chat_id,msg.id, "استعمل الامر هكذا :\n\n`سحب` المبلغ","md",true)
end
if text == 'حظ' then
...
return bot.sendText(msg.chat_id,msg.id,"- مايصير تلعب حظ  آلآن\n- تعال بعد "..math.floor(hours).." دقيقة","md",true)
end
bot.sendText(msg.chat_id,msg.id, "استعمل الامر هكذا :\n\n`حظ` المبلغ","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id, "- ماعندك حسا بنكي ","md",true)
end
...
bot.sendText(msg.chat_id,msg.id,[[
- ارسل  آلآن رقم الحساب البنكي الي تبي تحول له
...
return bot.sendText(msg.chat_id,msg.id,"- ارسل رقم حسا بنكي ","md",true)
end
if text == cccc then
redis:del(bot_id.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
redis:del(bot_id.."transn" .. msg.sender_id.user_id)
return bot.sendText(msg.chat_id,msg.id,"- مايصير تحول لنفسك ","md",true)
end
...
bot.sendText(msg.chat_id,msg.id, "- حوالة صادرة من -  الحلفي\n\n- المرسل : "..news.."\n- الحساب رقم : `"..cccc.."`\n- نوع البطاقة : "..uuuu.."\n- المستلم : "..newss.."\n- الحساب رقم : `"..text.."`\n- نوع البطاقة : "..fsvhh.."\n- خصمت 10% رسوم تحويل\n- المبلغ : "..convert_mony.." دينار عراقي 💵","md",true)
bot.sendText(fsvhhh,0, "- حوالة واردة من -  الحلفي\n\n- المرسل : "..news.."\n- الحساب رقم : `"..cccc.."`\n- نوع البطاقة : "..uuuu.."\n- المبلغ : "..convert_mony.." دينار عراقي 💵","md",true)
redis:del(bot_id.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
redis:del(bot_id.."transn" .. msg.sender_id.user_id)
else
bot.sendText(msg.chat_id,msg.id, "- مافيه حسا بنكي هكذا","md",true)
...
shkse = redis:get(bot_id.."shkse"..msg.sender_id.user_id)
if shkse == "طيبة" then
return bot.sendText(msg.chat_id,msg.id, "- شخصيتك طيبة مايصير تاخذ رشوة","md",true)
end
local daddd = {"1", "2", "3", "4",}
local haddd = daddd[math.random(#daddd)]
...
bot.sendText(msg.chat_id,msg.id,"- هذه رشوة بطل زرف "..jjjo.." دينار عراقي 💵","md",true)
...
shkse = redis:get(bot_id.."shkse"..msg.sender_id.user_id)
if shkse == "شريرة" then
return bot.sendText(msg.chat_id,msg.id, "- شخصيتك شريرة مايصير تاخذ بخشيش","md",true)
end
local jjjo = math.random(200,5000);
ballanceed = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
bakigcj = ballanceed + jjjo
redis:set(bot_id.."boob"..msg.sender_id.user_id , bakigcj)
bot.sendText(msg.chat_id,msg.id,"- تم اعطائك بخشيش "..jjjo.." دينار عراقي 💵","md",true)
redis:setex(bot_id.."iioo" .. msg.sender_id.user_id,620, true)
else
bot.sendText(msg.chat_id,msg.id, "- ماعندك حسا بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
...
shkse = redis:get(bot_id.."shkse"..msg.sender_id.user_id)
if shkse == "طيبة" then
return bot.sendText(msg.chat_id,msg.id, "- شخصيتك طيبة مايصير تزرف العالم","md",true)
end
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
...
return bot.sendText(msg.chat_id,msg.id,"- ذا التم مزروف قبل شوي\n- يمديك تزرفه بعد "..math.floor(hours).." دقيقة","md",true)
end
if redis:sismember(bot_id.."booob",Remsg.sender_id.user_id) then
ballanceed = redis:get(bot_id.."boob"..Remsg.sender_id.user_id) or 0
if tonumber(ballanceed) < 199 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تزرفه فلوسه اقل من 200 دينار عراقي 💵","md",true)
end
...
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
bot.sendText(msg.chat_id,0, "- "..news.." في حرامي زرفك "..hrame.." دينار عراقي 💵\n- رد عليه بكلمة ( شرطه )\n- معك 30 ثانية\n༄","md",true)
else
local hrame = math.floor(math.random() * 200) + 1;
local ballanceed = redis:get(bot_id.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
redis:set(bot_id.."rrfff"..msg.sender_id.user_id,zoroprod)
redis:sadd(bot_id.."rrfffid",msg.sender_id.user_id)
bot.sendText(msg.chat_id,msg.id, "- خذ يالحرامي زرفته "..hrame.." دينار عراقي 💵\n༄","md",true)
end
else
bot.sendText(msg.chat_id,msg.id, "- ماعنده حسا بنكي ","md",true)
end
...
shkse = redis:get(bot_id.."shkse"..msg.sender_id.user_id)
if shkse == "شريرة" then
return bot.sendText(msg.chat_id,msg.id, "- شخصيتك شريرة مايصير تطلب الشرطة","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id,"- راتبك ينزل بعد "..math.floor(hours).." دقيقة","md",true)
end
local ban = bot.getUser(msg.sender_id.user_id)
if ban.first_name then
...
return bot.sendText(msg.chat_id,msg.id, "- مايصير تطور راتبك تحتاج مبلغ 1000000000 دينار عراقي 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "- مايصير تطور راتبك تحتاج مبلغ 200000000 دينار عراقي 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "- مايصير تطور راتبك تحتاج مبلغ 30000000 دينار عراقي 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "- مايصير تطور راتبك تحتاج مبلغ 1000000 دينار عراقي 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "- مايصير تطور راتبك تحتاج مبلغ 300000 دينار عراقي 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "- مايصير تطور راتبك تحتاج مبلغ 120000 دينار عراقي 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "- مايصير تطور راتبك تحتاج مبلغ 80000 دينار عراقي 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "- مايصير تطور راتبك تحتاج مبلغ 30000 دينار عراقي 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "- مايصير تطور راتبك تحتاج مبلغ 3000 دينار عراقي 💵","md",true)
end
redis:del(bot_id.."ratbtrans"..msg.sender_id.user_id)
...
return bot.sendText(msg.chat_id,msg.id, "- مايصير تهجم فلوسك اقل من 100000 دينار عراقي 💵","md",true)
end
if tonumber(ballanceed) < 100000 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تهجم عليه فلوسه اقل من 100000 دينار عراقي 💵","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار ماسه بعملية وحدة\n༄","md",true)
end
...
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري فلوسك ماتكفي","md",true)
end
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار قلاده بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار سوار بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار خاتم بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار قصر بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار فيلا بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار منزل بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار طياره شبح بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار طياره سفر بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار طياره خاصه بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار سياره فيلار بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار سياره اكسنت بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار سياره كامري بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار سياره النترا بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار سياره هايلكس بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار سياره سوناتا بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if tonumber(coniss) > 1000000001 then
return bot.sendText(msg.chat_id,msg.id, "- مايصير تشتري اكثر من مليار سياره كورولا بعملية وحدة\n༄","md",true)
end
ballance = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
return bot.sendText(msg.chat_id,msg.reply_to_message_id, "- ماعندك حسا بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
bot.sendText(msg.chat_id,msg.id, "- تم اعزب مو متزوج","md",true)
end
end
if text == 'طلاق' then
if redis:sismember(bot_id.."roogg1",msg.sender_id.user_id) or redis:sismember(bot_id.."roogga1",msg.sender_id.user_id) then
...
if text == 'تفعيل السوبر' then
sm = bot.getChatMember(msg.chat_id,msg.sender_id.user_id)
if sm.status.luatele == "chatMemberStatusCreator" or programmer(msg) then
if redis:get(bot_id..":"..msg.chat_id..":Super") then
return bot.sendText(msg.chat_id,msg.id,'*- تم تفعيل البوت ك سوبر سابقا .*',"md",true)
end
if not redis:sismember(bot_id..":Groups",msg.chat_id) then
return bot.sendText(msg.chat_id,msg.id,'*- يجب تفعيل البوت اولا ثم تفعيله في مجموعه السوبر .*',"md",true)
end
redis:set(bot_id..":"..msg.chat_id..":Super",msg.sender_id.user_id)
return bot.sendText(msg.chat_id,msg.id,'*- تم تفعيل المجموعه ك سوبر ارسل اوامر السوبر الان .*',"md",true)
else
return bot.sendText(msg.chat_id,msg.id,'*- يجب ان تكون مالك المجموعه .*',"md")
end
end
if text == 'تعطيل السوبر' then
sm = bot.getChatMember(msg.chat_id,msg.sender_id.user_id)
if sm.status.luatele == "chatMemberStatusCreator" or programmer(msg) then
if redis:get(bot_id..":"..msg.chat_id..":Super") then
redis:del(bot_id..":"..msg.chat_id..":Super")
return bot.sendText(msg.chat_id,msg.id,'*- تم تعطيل المجموعه ك سوبر .*',"md",true)
else
return bot.sendText(msg.chat_id,msg.id,'*- لم يتم تفعيل المجموعه ك سوبر مسبقا .*',"md",true)
end
else
return bot.sendText(msg.chat_id,msg.id,'*- يجب ان تكون مالك المجموعه .*',"md",true)
end
end
----
if redis:get(bot_id..":"..msg.chat_id..":Super") then 
-----
if tonumber(msg.sender_id.user_id) ~= tonumber(redis:get(bot_id..":"..msg.chat_id..":Super")) and not redis:sismember(bot_id..":Status:"..msg.chat_id..":mediator",msg.sender_id.user_id) then    
if msg then
firse = bot.getUser(msg.sender_id.user_id).first_name
if firse then
if redis:sismember(bot_id..":prohibitions:"..msg.chat_id..":Textname",firse) then
bot.setChatMemberStatus(msg.chat_id,msg.sender_id.user_id,'banned',0)
local Info_ = redis:smembers(bot_id..":Status:"..msg.chat_id..":mediator") 
if #Info_ == 0 then
return bot.sendText(msg.chat_id,msg.id,Reply_Status(tonumber(redis:get(bot_id..":"..msg.chat_id..":Super")),Reply_Status(msg.sender_id.user_id,"*- تم طرده بنجاح ( منتحل ).*").i).yu,"md",true)  
end  
t = '\n— — — — — — — — — —\n'
for k, v in pairs(Info_) do
local UserInfo = bot.getUser(v)
...
t = t.. '— — — — — — — — — —\n*★ - *'..Reply_Status(tonumber(redis:get(bot_id..":"..msg.chat_id..":Super")),".").user.."\n— — — — — — — — — —\n"
return bot.sendText(msg.chat_id,msg.id,"- تنبيه ⚠️\n"..Reply_Status(msg.sender_id.user_id,t.."*- تم طرده بنجاح ( منتحل ).*").i,"md",true)  
end
end
end
--- 
if msg and GetBio(msg.sender_id.user_id) then
if redis:sismember(bot_id..":prohibitions:"..msg.chat_id..":Textbio",GetBio(msg.sender_id.user_id)) then
bot.setChatMemberStatus(msg.chat_id,msg.sender_id.user_id,'banned',0)
local Info_ = redis:smembers(bot_id..":Status:"..msg.chat_id..":mediator") 
if #Info_ == 0 then
return bot.sendText(msg.chat_id,msg.id,Reply_Status(tonumber(redis:get(bot_id..":"..msg.chat_id..":Super")),Reply_Status(msg.sender_id.user_id,"*- تم طرده بنجاح ( منتحل ).*").i).yu,"md",true)  
...
if text == 'مسح النبذات الممنوعه' then
local Info_ = redis:smembers(bot_id..":prohibitions:"..msg.chat_id..":Textbio") 
if #Info_ == 0 then
return bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"*- لا توجد قائمه بايوهات ممنوعه *").yu,"md",true)  
end  
redis:del(bot_id..":prohibitions:"..msg.chat_id..":Textbio") 
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"*- تم مسح القائمه بنجاح *").yu,"md",true)  
end
if text == 'مسح الاسماء الممنوعه' then
local Info_ = redis:smembers(bot_id..":prohibitions:"..msg.chat_id..":Textname") 
if #Info_ == 0 then
return bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"*- لا توجد قائمه اسماء ممنوعه *").yu,"md",true)  
end  
redis:del(bot_id..":prohibitions:"..msg.chat_id..":Textname") 
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"*- تم مسح القائمه بنجاح *").yu,"md",true)  
end
if text and text:match("^منع (.*) بالاسم") and msg.reply_to_message_id == 0 then
local Textname = text:match("^منع (.*) بالاسم")
if redis:sismember(bot_id..":prohibitions:"..msg.chat_id..":Textname",Textname) then    
return bot.sendText(msg.chat_id,msg.id,"*- تم منع هذه الكلمه مسبقاً .*","md",true)
end
redis:sadd(bot_id..":prohibitions:"..msg.chat_id..":Textname",Textname)
return bot.sendText(msg.chat_id,msg.id,"*- تم منع هذه الكلمه من الاسم بنجاح .*","md",true)
end
-----
if text and text:match("^منع (.*) بالنبذه") and msg.reply_to_message_id == 0 then
local Textbio = text:match("^منع (.*) بالنبذه")
if redis:sismember(bot_id..":prohibitions:"..msg.chat_id..":Textbio",Textbio) then    
return bot.sendText(msg.chat_id,msg.id,"*- تم منع هذه الكلمه مسبقاً .*","md",true)
end
redis:sadd(bot_id..":prohibitions:"..msg.chat_id..":Textbio",Textbio)
return bot.sendText(msg.chat_id,msg.id,"*- تم منع هذه الكلمه من النبذات بنجاح .*","md",true)
end
-----
if text and text:match("^الغاء منع (.*) بالاسم") and msg.reply_to_message_id == 0 then
local Textname = text:match("^الغاء منع (.*) بالاسم")
if not redis:sismember(bot_id..":prohibitions:"..msg.chat_id..":Textname",Textname) then    
return bot.sendText(msg.chat_id,msg.id,"*- الكلمه غير ممنوعه سابقا .*","md",true)
end
redis:srem(bot_id..":prohibitions:"..msg.chat_id..":Textname",Textname)
return bot.sendText(msg.chat_id,msg.id,"*- تم الغاء منع الكلمه من الاسماء بنجاح .*","md",true)
end
-----
if text and text:match("^الغاء منع (.*) بالنبذه") and msg.reply_to_message_id == 0 then
local Textbio = text:match("^الغاء منع (.*) بالنبذه")
if not redis:sismember(bot_id..":prohibitions:"..msg.chat_id..":Textbio",Textbio) then    
return bot.sendText(msg.chat_id,msg.id,"*- الكلمه غير ممنوعه سابقا .*","md",true)
end
redis:srem(bot_id..":prohibitions:"..msg.chat_id..":Textbio",Textbio)
return bot.sendText(msg.chat_id,msg.id,"*- تم الغاء منع الكلمه من النبذات بنجاح .*","md",true)
end
-----
if text == 'رفع وسيط' and msg.reply_to_message_id ~= 0 then
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if redis:sismember(bot_id..":Status:"..msg.chat_id..":mediator",Remsg.sender_id.user_id) then    
return bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender_id.user_id,"*- تم رفعه وسيط مسبقاً *.").i,"md",true)
end
redis:sadd(bot_id..":Status:"..msg.chat_id..":mediator",Remsg.sender_id.user_id)
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"* - تم رفع العضو وسيط بنجاح .*").yu ,"md",true)  
end
-----
if text and text:match('^رفع وسيط @(%S+)$') then
local UserName = text:match('^رفع وسيط @(%S+)$')
local UserId_Info = bot.searchPublicChat(UserName)
if not UserId_Info.id then
...
if redis:sismember(bot_id..":Status:"..msg.chat_id..":mediator",UserId_Info.id) then    
return bot.sendText(msg.chat_id,msg.id,Reply_Status(UserId_Info.id,"*- تم رفعه وسيط مسبقاً *.").i,"md",true)
end
redis:sadd(bot_id..":Status:"..msg.chat_id..":mediator",UserId_Info.id)
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"* - تم رفع العضو وسيط بنجاح .*").yu,"md",true)  
end
-----
if text and text:match('^رفع وسيط (%d+)$') then
local UserName = text:match('^رفع وسيط (%d+)$')
local UserInfo = bot.getUser(UserName)
if UserInfo.code == 400 or UserInfo.message == "Invalid user ID" then
bot.sendText(msg.chat_id,msg.id,"*- اليوزر ليس لحساب شخصي تأكد منه .*","md",true)  
return false
end
if redis:sismember(bot_id..":Status:"..msg.chat_id..":mediator",UserInfo.id) then    
return bot.sendText(msg.chat_id,msg.id,Reply_Status(UserInfo.id,"*- تم رفعه وسيط مسبقاً *.").i,"md",true)
end
redis:sadd(bot_id..":Status:"..msg.chat_id..":mediator",UserInfo.id)
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"* - تم رفع العضو وسيط بنجاح .*").yu,"md",true)  
end
-----
if text == 'تنزيل وسيط' and msg.reply_to_message_id ~= 0 then
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
if not redis:sismember(bot_id..":Status:"..msg.chat_id..":mediator",Remsg.sender_id.user_id) then    
return bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender_id.user_id,"*- تم تنزيله مسبقاً *.").i,"md",true)
end
redis:srem(bot_id..":Status:"..msg.chat_id..":mediator",Remsg.sender_id.user_id)
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"* - تم تنزيل الوسيط بنجاح .*").yu ,"md",true)  
end
-----
if text and text:match('^تنزيل وسيط @(%S+)$') then
local UserName = text:match('^تنزيل وسيط @(%S+)$')
local UserId_Info = bot.searchPublicChat(UserName)
if not UserId_Info.id then
bot.sendText(msg.chat_id,msg.id,"*- اليوزر ليس لحساب شخصي تأكد منه .*","md",true)  
return false
...
if not redis:sismember(bot_id..":Status:"..msg.chat_id..":mediator",UserId_Info.id) then    
return bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender_id.user_id,"*- تم تنزيله مسبقاً *.").i,"md",true)
end
redis:srem(bot_id..":Status:"..msg.chat_id..":mediator",UserId_Info.id)
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"* - تم تنزيل العضو بنجاح .*").yu,"md",true)  
end
-----
if text and text:match('^تنزيل وسيط (%d+)$') then
local UserName = text:match('^تنزيل وسيط (%d+)$')
local UserInfo = bot.getUser(UserName)
if UserInfo.code == 400 or UserInfo.message == "Invalid user ID" then
bot.sendText(msg.chat_id,msg.id,"*- اليوزر ليس لحساب شخصي تأكد منه .*","md",true)  
return false
end
if not redis:sismember(bot_id..":Status:"..msg.chat_id..":mediator",UserInfo.id) then    
return bot.sendText(msg.chat_id,msg.id,Reply_Status(Remsg.sender_id.user_id,"*- تم تنزيله مسبقاً *.").i,"md",true)
end
redis:srem(bot_id..":Status:"..msg.chat_id..":mediator",UserInfo.id)
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"* - تم تنزيل العضو بنجاح .*").yu,"md",true)  
end
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"*- ابشر فتحت السوق *").by,"md",true)
end
...
bot.sendText(msg.chat_id,msg.id,Reply_Status(msg.sender_id.user_id,"*- ابشر قفلت السوق *").by,"md",true)
end
...
local pricemarket = "- اهلين فيك في سوق الحلفي\nلائحة باسعار منتجات الحلفي :\n\n1) كشف وثيقة زواج 100 دينار عراقي 💵\n2) رتبه 5000000 دينار عراقي 💵\n3) منشن جماعي 1000000 دينار عراقي 💵\n4) ضع رد 10000000 دينار عراقي 💵\n- تستطيع استخدام ميزة ( استرداد المبلغ )\n- بالنسبة لميزة ضع رد اذا وجد رد مخالف يستطيع مشرفين لمجموعه مسحه بامر - مسح ضع رد\n༄"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if (text == 'طردد' or text == 'رفض') and msg.reply_to_message_id == 0 then
ballanceed = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
...
if redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
if redis:ttl(bot_id.."shbtime" .. msg.sender_id.user_id) >=60 then
local hours = redis:ttl(bot_id.."shbtime" .. msg.sender_id.user_id) / 60
...
local Textinggt1 = {"/tdbel", "/nonono", "/halfdbel",}
local Textinggt2 = {"/tdbel", "/nonono", "/halfdbel",}
local Textinggt3 = {"/tdbel", "/nonono", "/halfdbel",}
local Descriptioont1 = Textinggt1[math.random(#Textinggt1)]
local Descriptioont2 = Textinggt2[math.random(#Textinggt2)]
local Descriptioont3 = Textinggt3[math.random(#Textinggt3)]
ttshakse = '⇜ اسحب واربح\n༄'
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
...
redis:setex(bot_id.."aglahd" .. msg.sender_id.user_id,1800, true)
    local msg_text = ""
    local photo = "https://t.me/f_fqff/106"
...
return bot.sendText(msg.chat_id,msg.id, "استعمل الامر كذا :\n\nتبرع المبلغ","md",true)
end
if text == 'تبرع' then
if redis:ttl(bot_id.."tabrotime" .. msg.sender_id.user_id) >=60 then
local hours = (redis:ttl(bot_id.."tabrotime" .. msg.sender_id.user_id) / 60)
...
if text and tonumber(text:match("^تبرع (.*)")) and tonumber(msg.reply_to_message_id) == 0 then
local coniss = tonumber(text:match("^تبرع (.*)"))
if not redis:sismember(bot_id.."booob",msg.sender_id.user_id) then
return bot.sendText(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( انشاء حساب بنكي )","md",true)
end
ballanceed = redis:get(bot_id.."boob"..msg.sender_id.user_id) or 0
local ty_users = redis:smembers(bot_id.."booob")
mony_list = {}
for k,v in pairs(ty_users) do
...
table.sort(mony_list, function(a, b) return a[1] > b[1] end)
winner_id = mony_list[math.random(#mony_list)][2]
UserInfo = bot.getUser(winner_id)
if UserInfo.first_name and UserInfo.first_name ~= "" then
if UserInfo.username and UserInfo.username ~= "" then
UserInfousername = '['..UserInfo.first_name..'](t.me/'..UserInfo.username..')'
else
UserInfousername = '['..UserInfo.first_name..'](tg://user?id='..UserInfo.id..')'
end
else
UserInfousername = '[nil](https://t.me/fBBBBB)'
end
UserIno = bot.getUser(msg.sender_id.user_id)
if UserIno.first_name and UserIno.first_name ~= "" then
if UserIno.username and UserIno.username ~= "" then
UserInousername = '['..UserIno.first_name..'](t.me/'..UserIno.username..')'
else
UserInousername = '['..UserIno.first_name..'](tg://user?id='..UserIno.id..')'
end
else
UserInousername = '[nil](https://t.me/fBBBBB)'
end
convert_mony = string.format("%.0f",tonumber(coniss))
...
convert_monyy = string.format("%.0f",tonumber(ballanceeed))
bot.sendText(msg.chat_id,msg.id, "⌯ وصل تبرع 📄\n\n⇜ من : "..UserInousername.."\n⇜ المستفيد : "..winner_id.."\n⇜ المبلغ : "..convert_mony.." دينار 💵 \n⇜ فلوس المستفيد الان : "..convert_monyy.." دينار 💵\n✦","md",true)  
bot.sendText(winner_id,0, "⌯ وصلك تبرعات من : "..UserInfousername.."\n⇜ المبلغ : "..convert_mony.." دينار 💵","md",true)
end
...
type = 'inline',
data = {
{{text=" لعبة الحلفيي بيرد -  ",url='https://t.me/awesomebot?game=FlappyBird'}},
...
----------------------------------------------------------------------------------------------------
if text == "تقيد الرتبه" and Creator(msg) or text == "تقيد لرتبه" and Creator(msg) then
reply_markup = bot.replyMarkup{
type = 'inline',data = {
...
reply_to_message_id=msg.id,
reply_markup=markup(nil,{{{text = '- ᴀʟʜᴀʟᴀғɪɪ sᴏᴜʀᴄᴇ .',url="t.me/iinzzz"}}})
})
end
end
if not redis:get(bot_id..":"..msg.chat_id..":settings:singforme") then
...
local reply_markup = bot.replyMarkup{type = 'inline',data = {{{text = '- ᴀʟʜᴀʟᴀғɪɪ sᴏᴜʀᴄᴇ .', url = 't.me/iinzzz'}, },}}
return bot.sendText(msg.chat_id,msg.id,'*\n￤• عليك الاشتراك في قناة السورس اولاً ༄  ،*',"md",false, false, false, false, reply_markup)
end
local T =[[
[- WeLCoMe To 𝘢𝘭𝘩𝘢𝘭𝘢𝘧𝘪𝘪 𝘴𝘰𝘶𝘳𝘤𝘦 .](t.me/iinzzz)
